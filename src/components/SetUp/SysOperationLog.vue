<template>
	<div>
		...
		<div class="know-container">
			<data-tables v-loading="loading" :data="RevisionsData" :table-props="tableProps" align="left" :show-action-bar="false" :custom-filters="customFilters" :pagination-def="paginationDef">
